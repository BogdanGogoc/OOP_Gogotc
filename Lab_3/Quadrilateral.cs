...
public class Quadrilateral : IQuadrilateralBySides, IQuadrilateralByVertices
{
    ...
    public Quadrilateral(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4)
    {
        ...
        angles[0] = AngleBetween(v4, v1, true);
        angles[1] = AngleBetween(v1, v2, true);
        angles[2] = AngleBetween(v2, v3, true);
        angles[3] = AngleBetween(v3, v4, true);
    }
    ...
    private double AngleBetween(double[] vector1, double[] vector2, bool inRadians = false)
    {
